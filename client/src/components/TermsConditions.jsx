  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-orange-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-3xl shadow-xl shadow-amber-100/50 overflow-hidden">
          {/* Hero */}
          ...
          <div className="p-8 space-y-10">
            ...
            <section className="bg-amber-50 border border-amber-200 rounded-2xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-xl font-bold text-gray-800 mb-3">Kebijakan Masa Berlaku Undangan</h2>
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold text-gray-800">Penghapusan Data</h2>
              </div>
              <div className="text-gray-600 space-y-3 ml-13">
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold text-gray-800">Tanggung Jawab Pengguna</h2>
              </div>
              <div className="text-gray-600 space-y-3 ml-13">
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold text-gray-800">Batasan Tanggung Jawab</h2>
              </div>
              <div className="text-gray-600 space-y-3 ml-13">
            ...
            {/* Changes */}
            <section>
              <h2 className="text-xl font-bold text-gray-800 mb-4">Perubahan Ketentuan</h2>
            ...
            <section className="bg-gray-50 rounded-2xl p-6">
              <h2 className="text-xl font-bold text-gray-800 mb-3">Hubungi Kami</h2>
              <p className="text-gray-600">
                Jika Anda memiliki pertanyaan tentang syarat dan ketentuan ini, silakan hubungi kami melalui 
                email di <a href="mailto:support@kekkon.id" className="text-amber-600 hover:underline">support@kekkon.id</a>
              </p>
            </section>
