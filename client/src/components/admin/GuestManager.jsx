        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-800">Kelola Tamu</h1>
                {invitation && (
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        >
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-gray-50 border-0 rounded-xl focus:ring-2 focus:ring-amber-400 transition-all"
                />
              </div>
              ...
              <div className="flex items-center gap-2">
                <div className="relative">
                  <select
                    ...
                    className="appearance-none pl-4 pr-10 py-3 bg-gray-50 border-0 rounded-xl focus:ring-2 focus:ring-amber-400 text-sm font-medium cursor-pointer"
                  >
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-3 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-xl font-medium hover:shadow-lg hover:shadow-amber-200 transition-all"
                >
                  <UserPlus className="w-4 h-4" />
                  <span className="hidden md:inline">Tambah Tamu</span>
                </button>
                <label className="flex items-center gap-2 px-4 py-3 bg-gray-100 text-gray-700 rounded-xl font-medium hover:bg-gray-200 transition-colors cursor-pointer">
          ...
          <AnimatePresence>
            {showAddForm && (
              ...
              >
                <form onSubmit={handleAddGuest} className="p-5 bg-gradient-to-r from-amber-50 to-orange-50 border-b border-amber-100">
                  <div className="flex flex-col md:flex-row gap-4">
                    <div className="flex-1">
                      <label className="block text-xs font-medium text-gray-600 mb-1.5">Nama Tamu *</label>
                      <input
                        type="text"
                        value={newGuest.name}
                        onChange={(e) => setNewGuest({ ...newGuest, name: e.target.value })}
                        className="w-full px-4 py-3 bg-white border-0 rounded-xl focus:ring-2 focus:ring-amber-400"
                        placeholder="Masukkan nama tamu"
                        required
                      />
                    </div>
                    <div className="flex-1">
                      <label className="block text-xs font-medium text-gray-600 mb-1.5">No. Telepon (opsional)</label>
                      <input
                        type="text"
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {guest.message && (
                          <div className="mt-3">
                            <div 
                              className={`text-sm text-gray-600 bg-gray-50 rounded-xl p-3 ${expandedMessage === guest.id ? '' : 'line-clamp-2'}`}
                        ...
                        <div className="flex items-center gap-2 mt-3">
                          ...
                          <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-gray-500 hover:text-rose-600 hover:bg-rose-50 rounded-lg transition-colors"
                          >
        ...
        <div className="mt-6 p-5 bg-white rounded-2xl border border-gray-100">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-800 mb-1">Format Import CSV</h3>
              <p className="text-sm text-gray-500 mb-3">
                Untuk import tamu dalam jumlah banyak, gunakan format CSV berikut:
              </p>
              <code className="block p-3 bg-gray-50 rounded-lg text-sm text-gray-700 font-mono">
                nama,telepon<br/>
